    ...
    return (
      <main className="min-h-screen bg-void-950 flex items-center justify-center">
        <div className="text-center">
          <Spinner size="lg" />
          <p className="mt-4 text-slate-400 animate-pulse">Loading validation...</p>
        </div>
      </main>
    );
  }
          ...
          {isProcessing && (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-lg font-semibold text-white">Validation in Progress</h2>
              </div>
                ...
                <div className="space-y-10 animate-fade-in">
                  ...
                  {submission.verdict ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-16 text-center">
                      <Spinner size="lg" />
                      <p className="mt-4 text-slate-400">Generating AI verdict...</p>
                      <p className="mt-2 text-slate-500 text-sm">This usually takes 15-30 seconds</p>
                    </div>
                  ) : null}
